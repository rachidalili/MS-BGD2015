...
#--------------------------------------------------------------
honoraires_file = files_dir+'/Honoraires_totaux_des_professionnels_de_sante_par_departement_en_2013.xls'
...
#medDf = df.join(demoDf, on=['NUM_DEP'], how='inner')
...
#------------------------------------------------------------------------
#Est ce que la densité de certains médecins / praticiens est corrélé à la densité de population
# pour certaines classes d'ages (bebe/pediatre, personnes agées / infirmiers etc...) ?
#------------------------------------------------------------------------
# Rapporter le nombre par classe d'age pour 100 000 habitants
